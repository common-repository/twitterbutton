...
Yes. By disabling auto-output in the settings, the theme files can be used to render the button. See Advanced Usage at http://wiki.github.com/paulredmond/TwitterButton-Wordpress-Plugin/advanced-usage

= Can I disable auto-output? =
Yes. You can disable auto-output so that only manual function calls will render tweet buttons. You can also make the function calls disabled when auto-output is enable or override it so that both auto-output and your functions will render tweet buttons. See Advanced Usage http://wiki.github.com/paulredmond/TwitterButton-Wordpress-Plugin/advanced-usage
